$(document).ready(function() {
	...
	$(document.getElementById('add_hobby')).click(function(e){
        e.preventDefault();    
			$(document.getElementById('hobbies')).append('<div class="new"><input type="text" size = "40" placeholder="Hobby" class="p_info" style="color:white"><a href="#" class="remove_field" style="margin-right:30px; color:white; float:right"><i class="fa fa-times show-on-hover" aria-hidden="true"></i></a></div>');
    });  
	...
	$(document.getElementById('add_language')).click(function(e){
        e.preventDefault();    
			$(document.getElementById('languages')).append('<div class="new"><input type="text" size = "40" placeholder="Language" class="p_info" style="color:white"><a href="#" class="remove_field" style="margin-right:30px; color:white; float:right"><i class="fa fa-times show-on-hover" aria-hidden="true"></i></a></div>');
    });  
	...
	$(document.getElementById('add_skill')).click(function(e){
        e.preventDefault();    
			$(document.getElementById('technicalskills')).append('<div class="new"><input type="text" size = "30" placeholder="Skill" class="p_info" style="border:none; margin-left:40px; color:white;"><a href="#" class="remove_field" style="margin-right:30px; color:white; float:right"><i class="fa fa-times show-on-hover" aria-hidden="true"></i></a></div>');
    });  
	...
	$(document.getElementById('add_achievement')).click(function(e){
        e.preventDefault();    
			$(document.getElementById('achievements')).append('<div class="new"><input type="text" class="personalinfo" size = "30" placeholder="Position" style="font-weight:bold"><input type="text" class="personalinfo" size = "50" placeholder="Event" style=" margin-left:9px"><br><input type="text" class="personalinfo" size = "85" placeholder="Reason" style=" margin-left:0px"><a href="#" class="remove_field" style="margin-right:30px; color:black; float:right"><i class="fa fa-times show-on-hover" aria-hidden="true"></i></a></div>');
    });  
	...
	$(document.getElementById('add_eca')).click(function(e){
        e.preventDefault();    
			$(document.getElementById('eca')).append('<div class="new"><textarea rows="4" cols="40" placeholder="Add Activity" style="color:white"></textarea><a href="#" class="remove_field" style="margin-right:0px; color:white; float:right"><i class="fa fa-times show-on-hover" aria-hidden="true"></i></a></div>');
    });  
